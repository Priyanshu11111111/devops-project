...
function addFlight() {
    ...
    fetch("http://a41090161d125419985423559d6d1b8c-1478416866.us-east-1.elb.amazonaws.com/api/add_flight", {
        method: 'POST',
...
function deleteFlight() {
    ...
    fetch("http://a41090161d125419985423559d6d1b8c-1478416866.us-east-1.elb.amazonaws.com/api/delete_flight/${flightId}", {
        method: 'DELETE'
    })
    .then(response => response.json())
    .then(data => alert(data.message))
...
function fetchFlights() {
    fetch("http://a41090161d125419985423559d6d1b8c-1478416866.us-east-1.elb.amazonaws.com/api/fetch_flights")
    .then(response => {
        if (!response.ok) {
